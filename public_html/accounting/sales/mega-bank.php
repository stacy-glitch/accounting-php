...
$modules = [
    ...
    [
        ...
        'children' => [
            ...
            ['label' => '兆豐銀行', 'href' => './mega-bank.php', 'active' => true],
...
<body data-initial-year="<?php echo htmlspecialchars((string) $year, ENT_QUOTES, 'UTF-8'); ?>" data-initial-month="<?php echo htmlspecialchars((string) $month, ENT_QUOTES, 'UTF-8'); ?>">
  <div class="layout">
    ...
    <main class="content">
      <section class="sales-card" data-mega-card>
        <div class="sales-toolbar">
          <button type="button" class="btn btn--success sales-toolbar__nav-button" data-mega-nav="prev">‹ 上月</button>
          <h1 class="sales-toolbar__title" data-mega-title>-- 年 -- 月兆豐銀行明細</h1>
          <button type="button" class="btn btn--success sales-toolbar__nav-button" data-mega-nav="next">下月 ›</button>
        </div>
        <div class="sales-toolbar actions-row">
          <div></div>
          <div class="sales-toolbar__actions">
            <button type="button" class="btn btn--success" data-action="upload-mega">📁 上傳</button>
            <button type="button" class="btn btn--danger-soft" data-action="download-mega">📥 下載</button>
            <input type="file" data-mega-upload-input accept=".xlsx,.xls,.csv,.pdf" hidden>
          </div>
        </div>
        <div class="table-container">
          <table class="sales-table" data-mega-table>
            <thead>
              <tr>
                <th scope="col">帳務日期</th>
                <th scope="col">摘要</th>
  ...
  <script src="../assets/js/sales-mega.js?v=20251228" defer></script>
</body>
</html>
