...
2025-11-16 零用金：已清 2024/1–3 並重上傳 1、2 月，餘額仍偏高（餘額欄放代墊欄、日期用序號）；需將餘額移到正確欄、日期改文字後再匯，或改匯入直接採用檔案餘額。

2025-11-16 登入/登出：auth_guard + sidebar.js 加入登入保護與右上登出；明日確認其他頁面樣式是否需調整。
